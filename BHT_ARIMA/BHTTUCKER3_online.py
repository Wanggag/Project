...
class BHTTUCKER3_online(object):
    def __init__(self,X1,X2, X3,Rs, K, tol, seed=None, Us_mode=4, \
...
#        begin_idx = self._p + self._q
    ...
    def run(self):
        ...
        Us,coress1, coress2,corest,X_S,X_T,loss    = self._run()
          
        if self._convergence_loss:
            
            return Us,coress1, coress2, corest,X_S,X_T,loss      
        
        return  Us,coress1, coress2, corest,X_S,X_T,None
...
#得到更新后的源域和目标域的核张量             
        coress1 = self._get_cores(Xss1, Us)
        coress2 = self._get_cores(Xss2, Us)
        ...
        X_S = tl.tenalg.multi_mode_dot(coress11, Us)
        X_S2 = tl.tenalg.multi_mode_dot(coress21, Us)
        X_T = tl.tenalg.multi_mode_dot(corest1, Us)
...
#        ori_shape1 = torch.array(ori_shape1)        
#        ori_shape2 = list(self._ts_ori2_shape)        
#        ori_shape2 = torch.array(ori_shape2)
#        ori_shape3 = list(self._ts_ori3_shape)        
#        ori_shape3 = torch.array(ori_shape3)
#        ori_shape4 = list(self._ts_ori4_shape)        
#        ori_shape4 = torch.array(ori_shape4)
#        ori_shape5 = list(self._ts_ori5_shape)        
#        ori_shape5 = torch.array(ori_shape5)
#        ori_shape6 = list(self._ts_ori6_shape)        
#        ori_shape6 = torch.array(ori_shape6)
#        ori_shape7 = list(self._ts_ori7_shape)        
#        ori_shape7 = torch.array(ori_shape7)
#
#        
...
#        X_S7 = self._inverse_MDT(mdt7, new_X_source7, self._taus, ori_shape7)
        ...
        return Us,coress1,coress2, corest,X_S,X_T,con_loss 